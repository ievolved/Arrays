...
let L1 = function() {
  ...
  //  6. Return index of the nth tail odd in the array, null if no odd numbers
  //
  //
  //  This one is a little trickier than the others.  In this case, we'll be looking for the index
  //   position of the nth tail odd in the list.  So, findNthLastOdd(1) should return 11.  This
  ...
  this.findNthLastOdd = (input, nth) => {
    // Return the nth tail odd number
