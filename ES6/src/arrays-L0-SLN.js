...
let L0 = function() {
  ...
  //  is the head or tail number a multiple of 3?
  //
  //
  // What is the Time Complexity of your solution?  : O(n)
  // What is the Space Complexity of your solution? : O(1)
  ...
  // #15 At Odds
  //
  // Write a function that receives an array of positive numbers from 0 to 100.  Starting at the tail
  //  element in the array and ending at the head element, generate a new array with all the odd numbers
  ...
  //  as possible.
  //
  // HINT: The range may not start on that multiple.  You'll have to discover it head and then
  ...
  //        multiple is closest to each head.
  //
  //
  // Constraints:
  //
